...
CREATE TABLE IF NOT EXISTS "build_promotions" (
    ...
    "library_thread_id" VARCHAR(64) NOT NULL UNIQUE,
    "workshop_thread_id" VARCHAR(64) NOT NULL UNIQUE,
    "promoted_by_disc_uuid" VARCHAR(255) NOT NULL,
    "promoted_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "sync_complete_at" TIMESTAMP NOT NULL
...
CREATE TABLE IF NOT EXISTS "dm_sent_log" (
    ...
    CONSTRAINT "uid_dm_sent_log_disc_uu_2f8919" UNIQUE ("disc_uuid", "kind")
) /* Tracks one-shot DMs already sent (e.g. first-install chains-DM, member */;
CREATE TABLE IF NOT EXISTS "dead_guild_alerts" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE IF NOT EXISTS "first_install_monitors" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "guild_capacity_alerts" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE IF NOT EXISTS "intercult_messages" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "sender_cult_name" VARCHAR(64) NOT NULL,
    "target_cult_name" VARCHAR(64) NOT NULL,
    "sender_disc_uuid" VARCHAR(255) NOT NULL,
    "content" TEXT NOT NULL,
    "sent_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
) /* One outbound cross-cult message sent via the pinned intercult button. */;
CREATE INDEX IF NOT EXISTS "idx_intercult_m_sender__fd3e5b" ON "intercult_messages" ("sender_cult_name");
...
CREATE TABLE IF NOT EXISTS "link_code" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "mc_username" VARCHAR(64) NOT NULL UNIQUE,
    "disc_uuid" VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "minecraft_accounts" (
    ...
    "guild" VARCHAR(255),
    "wynn_username" VARCHAR(255) NOT NULL,
    "mc_username" VARCHAR(255) NOT NULL,
    "last_online" TIMESTAMP NOT NULL,
    "last_manual_check" TIMESTAMP NOT NULL,
    "last_seen_server" VARCHAR(16),
    "server_observed_at" TIMESTAMP,
    "first_join" TIMESTAMP,
    "token" VARCHAR(6),
    "is_honourary" INT NOT NULL DEFAULT 0
);
CREATE TABLE IF NOT EXISTS "blocklist" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "reason" VARCHAR(500),
    "blocked_by_disc_uuid" VARCHAR(255),
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "minecraft_account_id" CHAR(36) NOT NULL UNIQUE REFERENCES "minecraft_accounts" ("id") ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS "cults" (
    ...
    "thread_id" BIGINT,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "owner_id" CHAR(36) NOT NULL REFERENCES "minecraft_accounts" ("id") ON DELETE RESTRICT
...
CREATE TABLE IF NOT EXISTS "discord_accounts" (
    ...
    "minecraft_account_id" CHAR(36) UNIQUE REFERENCES "minecraft_accounts" ("id") ON DELETE SET NULL
);
CREATE TABLE IF NOT EXISTS "cult_memberships" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "joined_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "cult_id" CHAR(36) NOT NULL REFERENCES "cults" ("id") ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "link_requests" (
    ...
    "minecraft_account_id" CHAR(36) NOT NULL REFERENCES "minecraft_accounts" ("id") ON DELETE CASCADE,
    CONSTRAINT "uid_link_reques_minecra_72bb15" UNIQUE ("minecraft_account_id", "discord_account_id")
);
CREATE TABLE IF NOT EXISTS "minecraft_alts" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "discord_account_id" CHAR(36) NOT NULL REFERENCES "discord_accounts" ("id") ON DELETE CASCADE,
    "minecraft_account_id" CHAR(36) NOT NULL REFERENCES "minecraft_accounts" ("id") ON DELETE CASCADE,
    CONSTRAINT "uid_minecraft_a_discord_e86398" UNIQUE ("discord_account_id", "minecraft_account_id")
...
CREATE TABLE IF NOT EXISTS "profession_categories" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "prof_type" VARCHAR(14) NOT NULL /* FARMING: farming\nFISHING: fishing\nMINING: mining\nWOODCUTTING: woodcutting\nALCHEMISM: alchemism\nARMOURING: armouring\nCOOKING: cooking\nJEWELING: jeweling\nSCRIBING: scribing\nTAILORING: tailoring\nWEAPONSMITHING: weaponsmithing\nWOODWORKING: woodworking */,
    "category" VARCHAR(8) NOT NULL /* PLEB: pleb\nVOID: void\nDERNIC: dernic\nTITANIUM: titanium\nCINNABAR: cinnabar */,
    "minecraft_account_id" CHAR(36) NOT NULL REFERENCES "minecraft_accounts" ("id") ON DELETE CASCADE,
    CONSTRAINT "uid_profession__minecra_78e1ad" UNIQUE ("minecraft_account_id", "prof_type")
);
CREATE TABLE IF NOT EXISTS "recruitment_queries" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "cult_name" VARCHAR(64) NOT NULL,
...
CREATE INDEX IF NOT EXISTS "idx_recruitment_cult_na_6e2af8" ON "recruitment_queries" ("cult_name");
CREATE TABLE IF NOT EXISTS "shouts" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "shouter_id" CHAR(36) NOT NULL REFERENCES "discord_accounts" ("id") ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "staff_action_entries" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "target_uuid" VARCHAR(36) NOT NULL,
    "target_username_at_time" VARCHAR(64) NOT NULL,
    "actor_uuid" VARCHAR(36) NOT NULL,
    "actor_username_at_time" VARCHAR(64) NOT NULL,
    "kind" VARCHAR(16) NOT NULL,
    "points" INT NOT NULL,
    "message" TEXT,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
) /* Audit row for a single caution \/ warning \/ eject event recorded by */;
CREATE INDEX IF NOT EXISTS "idx_staff_actio_target__96ee62" ON "staff_action_entries" ("target_uuid");
...
CREATE TABLE IF NOT EXISTS "user_vanity_choices" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
    "disc_uuid" VARCHAR(255) NOT NULL UNIQUE,
    "role_id" VARCHAR(255) NOT NULL,
    "chosen_by_staff" INT NOT NULL DEFAULT 0,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
) /* Records that a user has manually picked a vanity role via \/vanity. The */;
CREATE TABLE IF NOT EXISTS "verify_keys" (
    "id" CHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "scores" (
    ...
    "score" INT NOT NULL,
    "discord_account_id" CHAR(36) NOT NULL REFERENCES "discord_accounts" ("id") ON DELETE CASCADE,
    "event_id" CHAR(36) NOT NULL REFERENCES "weekly_events" ("id") ON DELETE CASCADE,
    CONSTRAINT "uid_scores_event_i_379816" UNIQUE ("event_id", "discord_account_id")
);
